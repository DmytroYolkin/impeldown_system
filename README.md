...
Actor should have few pages to change through:
 - main, inventory and if you have devil fruit, devil fruit change

---

#### Main
Contains stats, mastery, devil fruit (Null as difault), wounds checkbox
  ...
  **Mastery** can be created inside of character sheet without creating a sheet inside.
  ...
  - we should be able to choose between arsenal and mastery. Where arsenal can have inside of it a sheet with discription
